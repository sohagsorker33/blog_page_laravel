                    ...
                    <div class="post-single-body">
                        ...
                        <div class="post-single-title">
                            ...
                            <ul class="entry-meta">
                                ...
                                <li class="entry-cat"> <a href="{{ route('category.post',$post->category_id) }}" class="category-style-1 "> <span class="line"></span> {{ $post->cat_relation->category_name }}</a></li>
                        ...
                        <div class="post-single-author ">
                            <div class="authors-info">
                                ...
                                <div class="content">
                                    <h4>{{ $post->author_relation->name }}</h4>
                                    <p> {{ $post->author_relation->short_desp }}
                                    </p>
                                    <div class="social-media">
                                        <ul class="list-inline">
                                            <li>
